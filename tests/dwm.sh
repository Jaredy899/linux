...
setupDWM() {
    ...
    case "$PACKAGER" in
        ...
        dnf)
            ...
            ;;
        zypper)
            $ESCALATION_TOOL "$PACKAGER" install -y xorg-x11 xinit gcc make libX11-devel libXinerama-devel libXft-devel imlib2-devel libev-devel libxcb-devel dbus-1-devel git meson uthash-devel
            ;;
        *)

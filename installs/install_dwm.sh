...
setupDWM() {
    ...
    case "$PACKAGER" in
        pacman)
            $ESCALATION_TOOL $PACKAGER noninteractive "xorg-xinit" "xorg-server" "base-devel" "libx11" "libxinerama" "libxft" "imlib2" "libxcb" "meson" "libev" "uthash" "libconfig"
            ;;
        apt|nala)
            $ESCALATION_TOOL $PACKAGER noninteractive "xorg" "xinit" "build-essential" "libx11-dev" "libxinerama-dev" "libxft-dev" "libimlib2-dev" "libxcb1-dev" "libxcb-res0-dev" "libconfig-dev" "libdbus-1-dev" "libegl-dev" "libev-dev" "libgl-dev" "libepoxy-dev" "libpcre2-dev" "libpixman-1-dev" "libx11-xcb-dev" "libxcb1-dev" "libxcb-composite0-dev" "libxcb-damage0-dev" "libxcb-dpms0-dev" "libxcb-glx0-dev" "libxcb-image0-dev" "libxcb-present-dev" "libxcb-randr0-dev" "libxcb-render0-dev" "libxcb-render-util0-dev" "libxcb-shape0-dev" "libxcb-util-dev" "libxcb-xfixes0-dev" "libxext-dev" "meson" "ninja-build" "uthash-dev" "unzip"
            ;;
        dnf)
            $ESCALATION_TOOL $PACKAGER noninteractive "@Development Tools" "xorg-x11-xinit" "xorg-x11-server-Xorg" "libX11-devel" "libXinerama-devel" "libXft-devel" "imlib2-devel" "libxcb-devel" "dbus-devel" "gcc" "git" "libconfig-devel" "libdrm-devel" "libev-devel" "libX11-devel" "libX11-xcb" "libXext-devel" "libxcb-devel" "libGL-devel" "libEGL-devel" "libepoxy-devel" "meson" "pcre2-devel" "pixman-devel" "uthash-devel" "xcb-util-image-devel" "xcb-util-renderutil-devel" "xorg-x11-proto-devel" "xcb-util-devel"
            ;;
        zypper)
            $ESCALATION_TOOL $PACKAGER noninteractive "make" "xinit" "xorg-x11-server" "libX11-devel" "libXinerama-devel" "libXft-devel" "imlib2-devel" "libxcb-devel" "libxcb-devel" "dbus-1-devel" "gcc" "git" "libconfig-devel" "libdrm-devel" "libev-devel" "libX11-devel" "libX11-xcb1" "libXext-devel" "libxcb-devel" "Mesa-libGL-devel" "Mesa-libEGL-devel" "libepoxy-devel" "meson" "pcre2-devel" "uthash-devel" "xcb-util-image-devel" "libpixman-1-0-devel" "xcb-util-renderutil-devel" "xcb-util-devel"
            ;;
        *)
            printf "%b\n" "${RED}Unsupported package manager: $PACKAGER${RC}"
            exit 1
